...
<div class="container">
	...
	<?php
		...
		!empty($zerif_copyright) || !empty($zerif_socials_instagram) ):
					...
					echo '<div class="zerif-copyright-box">'.__('Powered by','zerif-lite').'<a class="zerif-copyright" href="http://wordpress.org/"'.$attribut_new_tab.' rel="nofollow"> WordPress</a>. Built by: <a href="https://www.machothemes.com/" title="Professional Responsive WordPress Themes" rel="dofollow">Macho Themes</a></div>';
